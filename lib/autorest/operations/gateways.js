 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Gateways.prototype.getDatasources = function (collectionName, gatewayId, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Construct URL
  var requestUrl = this.client.baseUri +
                   '//beta/collections/{collectionName}/gateways/{gatewayId}/datasources';
  requestUrl = requestUrl.replace('{collectionName}', encodeURIComponent(collectionName));
  requestUrl = requestUrl.replace('{gatewayId}', encodeURIComponent(gatewayId));
  // trim all duplicate forward slashes in the url
  var regex = /([^:]\/)\/+/gi;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Gateways.prototype.createDatasource = function (collectionName, gatewayId, datasourceToGatewayRequest, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  try {
    if (datasourceToGatewayRequest !== null && datasourceToGatewayRequest !== undefined) {
      var requestModelMapper = new client.models['PublishDatasourceToGatewayRequest']().mapper();
      requestModel = client.serialize(requestModelMapper, datasourceToGatewayRequest, 'datasourceToGatewayRequest');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    var serializationError = new Error(util.format('Error "%s" occurred in serializing the ' + 
        'payload - "%s"', error.message, util.inspect(datasourceToGatewayRequest, {depth: null})));
    return callback(serializationError);
  }
  httpRequest.body = requestContent;
  // Send Request
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 201) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['GatewayDatasource']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        var deserializationError = new Error(util.format('Error "%s" occurred in deserializing the responseBody - "%s"', error, responseBody));
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Gateways.prototype.getDatasourceById = function (collectionName, gatewayId, datasourceId, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Construct URL
  var requestUrl = this.client.baseUri +
                   '//beta/collections/{collectionName}/gateways/{gatewayId}/datasources/{datasourceId}';
  requestUrl = requestUrl.replace('{collectionName}', encodeURIComponent(collectionName));
  requestUrl = requestUrl.replace('{gatewayId}', encodeURIComponent(gatewayId));
  requestUrl = requestUrl.replace('{datasourceId}', encodeURIComponent(datasourceId));
  // trim all duplicate forward slashes in the url
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Gateways.prototype.deleteDatasource = function (collectionName, gatewayId, datasourceId, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
